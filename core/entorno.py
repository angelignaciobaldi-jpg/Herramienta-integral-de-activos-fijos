...
El PAT se comparte con las demás herramientas Quetzaltic (misma variable
QUETZALTIC_GITHUB_PAT): un único token de solo lectura de los repos privados
sirve para todas las apps del vendor en la misma máquina.
"""
