...
- Las variables de entorno (`.env`) siguen sirviendo para DESARROLLO.
...
# URL base por defecto. Vacía en el andamiaje: se fija por proyecto desde
# Configuración o variable de entorno. La preferencia local y la variable de
